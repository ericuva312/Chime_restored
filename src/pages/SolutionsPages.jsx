        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Stop reacting to market changes and start predicting them. Genesis gives you the strategic intelligence of a Fortune 500 company, positioning you as the market leader who sets trends instead of following them.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                From Market Follower to Market Prophet
              </h2>
              <p className="text-lg text-gray-600 mb-8">
                Imagine being the business everyone else copies. Imagine predicting the next big trend while your competitors are still figuring out the last one. Imagine having Fortune 500-level strategic intelligence guiding every decision.
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Before Genesis:</h4>
                    <p className="text-gray-600">Always reacting to market changes, missing opportunities, following competitors, making decisions based on outdated information</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">After Genesis:</h4>
                    <p className="text-gray-600">Predicting trends 6-8 weeks early, setting market direction, competitors copying your moves, strategic decisions backed by AI intelligence</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Real Strategic Results</h3>
              <div className="space-y-4">
                <div className="pl-4">
                  <p className="font-semibold text-gray-900">"I was always behind on trends"</p>
                  <p className="text-gray-600 text-sm">Now I predict and capitalize on trends 6 weeks early</p>
                  <p className="text-blue-600 font-semibold text-sm">First-mover advantage on every opportunity</p>
                </div>
                <div className="pl-4">
                  <p className="font-semibold text-gray-900">"Made decisions based on gut feelings"</p>
                  <p className="text-gray-600 text-sm">Now have Fortune 500-level strategic intelligence</p>
                  <p className="text-emerald-600 font-semibold text-sm">347% improvement in strategic outcomes</p>
                </div>
              </div>
            </div>
          </div>

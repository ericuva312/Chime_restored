...
const EnhancedROICalculator = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    // Step 2: Business Category & Performance (REPLACED industry with business_category)
    business_category: '',
  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      case 1:
        ...
        break;
      case 2:
        if (!formData.business_category || formData.business_category === '') {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Map business_category back to industry for backend compatibility

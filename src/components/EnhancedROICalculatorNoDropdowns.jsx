  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      case 1:
        ...
        break;
      case 2:
        if (!formData.business_category) newErrors.business_category = 'Business category selection is required';
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            <label key={category.value} className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
              <input
                type="radio"
      ...
      <div>
        ...
        <div className="space-y-3">
          {[
            ...
            <label key={stage.value} className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
              <input
                type="radio"
                name="business_stage"
                value={stage.value}
                ...
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <span className="ml-3 text-sm text-gray-700">{stage.label}</span>
            </label>
          ))}
        </div>
